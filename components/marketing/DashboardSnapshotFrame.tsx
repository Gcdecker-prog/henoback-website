...
export function DashboardSnapshotFrame({
  ...
  return (
    <div
      className={cn(
        'relative overflow-hidden rounded-2xl border border-neutral-200/80 bg-white shadow-[0_28px_72px_-28px_rgba(23,23,23,0.18),inset_0_1px_0_0_rgba(255,255,255,1)]',
        className,
      )}
    >
      <div className="flex items-center justify-between gap-3 border-b border-neutral-100 bg-neutral-50/80 px-5 py-3.5 sm:px-6">
